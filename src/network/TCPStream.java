...
public class TCPStream extends Thread {
    ...
    public void run() {
        ...
        try {
            if (this.asServer) {
                System.out.println("TCPChannel: note: this impl will only accept *one* connection attempt as server");
            ...
            if (this.listener != null) {
                ...
                System.out.println("send channel to listener");
            }
        } catch (IOException ioe) {
            //debug////////////////////////////////////
            String s = "couldt's establish connection";
    ...
    public void checkConnected() throws IOException {
        if (this.socket == null) {
            //debug///////////////////////////////////////////////
            String s = "no socket yet - should call connet first";
            System.out.println(s);
            //////////////////////////////////////////////////////
        }
    }
        ...
        Socket getSocket() throws IOException {
            while (!this.killed) {
                try {
                    ...
                    b.append(name);
                    b.append("): ");
                    b.append("falied / wait and re-try");
                    b.append(port);
                    System.out.println(b.toString());
                    //////////////////////////////////////
                    try {
